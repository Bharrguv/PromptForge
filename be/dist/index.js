...
app.post("/template", async (req, res) => {
    ...
    const isFrontend = frontendKeywords.some((keyword) => prompt.toLowerCase().includes(keyword));
    if (isFrontend) {
        res.json({
            prompts: [
                BASE_PROMPT,
